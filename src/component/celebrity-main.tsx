...
// export default function CelebrityManager() {
//   const [searchQuery, setSearchQuery] = useState('')

//   return (
//     <div className="w-full mx-auto py-8 px-4">
//       <h1 className="text-2xl font-bold mb-6">Celebrity Manager</h1>
...
//         />
//       </div>
//       <CelebrityList searchQuery={searchQuery} initialCelebrities={celebritiesData} />
//     </div>
//   )
// }
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-6">
          <h1 className="text-2xl font-bold text-center">Celebrity Manager</h1>
